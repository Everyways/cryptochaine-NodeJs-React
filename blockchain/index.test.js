...
describe('Blockchain()', () => {
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with the genesis block and has multiple blocks', () => {
            ...
            describe('and the chain does not contains any onvalid blocks', () => {
                it('returns true', () => {
    ...
    describe('validTransactionData()', () => {
        ...
        beforeEach(() => {
            wallet = new Wallet();
            transaction = wallet.createTransaction({ recipient: 'foo-address', amount: 85 });
