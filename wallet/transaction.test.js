...
describe('Transaction', () => {
    ...
    describe('validTransaction()', () => {
        ...
        describe('when the transaction is invalid', () => {
            describe('and a transaction ouptupMap value is invalid', () => {
    ...
    describe('update()', () => {
        ...
        describe('and the amount is valid', () => {
            ...
            describe('and another update for each recipient', () => {
                let addedAmount;
                ...
                it('susbtracts the amount from the original sender output amount', () => {
